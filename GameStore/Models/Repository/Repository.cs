...
namespace GameStore.Models.Repository
{
	public class Repository
	{
		...
		public void SavePersonnel(Personnel pers)
		{
			if (pers.PersId == 0)
			{
				pers = context.Personnels.Add(pers);
			}
			else
			{
				Personnel dbPersonnel = context.Personnels.Find(pers.PersId);
				if (dbPersonnel != null)
				{
					dbPersonnel.Name = pers.Name;
					dbPersonnel.Line1 = pers.Line1;
					dbPersonnel.Line2 = pers.Line2;
					dbPersonnel.Line3 = pers.Line3;
					dbPersonnel.City = pers.City;
					dbPersonnel.Style = pers.Style;
					dbPersonnel.Groupe = pers.Groupe;
				}
			}
			context.SaveChanges();
		}
